...
Config.TicketSystem = false -- Enable this if you want to use the ticket system false
...
Config.Peds = false -- "true" to enable peds spawning in banks
Config.PedPool = {
	[1] = `IG_Bankman`,
	[2] = `U_M_M_BankMan`,
	[3] = `S_F_M_Shop_HIGH`,
...
Config.useATM = false -- Enable this to use my ATM's
Config.useBanks = false -- Enable this to use my banking stuff
