...
Config = {
	Debug = false,
	Manage = false, -- "true" if using qb-management
    ...
    CustomCashRegisters = {
		["blazeit"] = { -- Player job role restriction
			{ coords = vector4(368.457, -1268.346, 32.476, 145.007), prop = true, }, -- vector4 to place the till and the way it faces
      	},
		...
		["thebrewingcompany"] = { -- Player job role restriction
			{ coords = vector4(-1384.514, -303.069, 43.91, 278.123), prop = true, }, -- vector4 to place the till and the way it faces
      	},
		["embassy"] = { -- Player job role restriction
